...
use "C:\AAA\PYAN\CLHLS\Longitudinal data\2002_2014_longitudinal_dataset_released_version1.dta"
****Extract the new added data at 2002 survey
gen int id_year=mod(id,100)
keep if id_year==02 //9748 obs
...
* -7: it is for the deceased persons, not applicable for survivors*/
* . 99: missing*/
*dth02_05, dth05_08, dth08_11, dth11_14: status of survival, death, or lost to follow-up from 2000-2002/2002-2005/2005-2008/2008-2011/2011-2014 waves*/
...
restore
keep if dth08_11==2&(dth11_14==-9|dth11_14==0|dth11_14==1) //id=50001898,45107898
...
clear
use "C:\AAA\PYAN\CLHLS\Longitudinal data\2002_2014_longitudinal_dataset_released_version1.dta"  //******need to be changed
gen int id_year=mod(id,100)
keep if id_year==02
...
use wave14,clear
append using wave5 wave8 wave11                                                 //******need to be changed
...
* day02: day of interview of the 2002 survey; 1~31, 99=missing
* month02: month of the interview of the 2002 survey*; 1~12, 99=missing
...
recode day02(99=15) if month02!=99 //3 changed                                  //******need to be changed
...
gen interview_baseline=mdy(month02,day02,2002)
...
* generate dthyear/month/day, means the exact death year/month/day of those who died during the whole period(2002-2014)
